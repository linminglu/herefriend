...
func InstallRoutes(m *martini.ClassicMartini) {
	...
	m.Get("/cms/recentComments", cms.RecentComments)
	...
	m.Get("/cms/AdminGiveVipLevel", cms.AdminGiveVipLevel)
	...
	m.Get("/cms/AdminChartsList", cms.AdminChartsList)
	...
	m.Get("/cms/GetGiftList", cms.GetGiftList)
	m.Get("/cms/GetGiftVerbose", cms.GetGiftVerbose)
}
